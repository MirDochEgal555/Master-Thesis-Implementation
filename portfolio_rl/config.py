...
class TrainConfig:
    ...
    dyn_sim_use_roll_features: bool = True
    dyn_sim_roll_detach: bool = True
    dyn_train_during_policy: bool = True
    dyn_sim_use_model_uncertainty: bool = True
    dyn_sim_use_kf_uncertainty: bool = True
